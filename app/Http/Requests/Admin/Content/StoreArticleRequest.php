...
class StoreArticleRequest extends BaseFormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // كاتب الرأي عند الإنشاء التحريري — يُتحقَّق منه في الحارس
            ...
            // P4-D1: المصدر الأساسي TipTap JSON بقائمة سماح صارمة
            ...
            // إسناد وسائط المكتبة المركزية (client-stage → attach-on-save)
