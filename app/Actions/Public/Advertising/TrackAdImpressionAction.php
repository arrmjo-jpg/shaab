...
/**
 * تأكيد الانطباع بمنارة العميل (POST /ads/track/impression). الرمز يحمل (placement,
 * zone, bucket) ويُفكّ ويُتحقَّق منه؛ التصفية (بوت) ومنع التكرار/إعادة التشغيل داخل
 * AdTracker. نُعيد accepted دائماً عند رمز صالح (لا تسريب لحالة الاحتساب). لا تُخزَّن (no-store).
 */
final class TrackAdImpressionAction
{
