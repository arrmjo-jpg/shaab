...
/**
 * قائمة مقالات الكاتب نفسه (نطاق عام — V1).
 *
 * تُرجع كل مقالات الكاتب بكل الحالات (draft/submitted/.../rejected) ليرى حالة
 * ما أرسله. غير قابلة للكاش (per-user، تحوي مسودّات خاصّة). القراءة محصورة
 * بـ author_id = الفاعل — لا يرى محتوى غيره. يعيد استخدام ArticleResource
 * (نفس عقد الإنشاء/الإرسال في V1) للاتساق وإظهار status.
 */
class ListMyArticlesAction
{
