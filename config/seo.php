...
return [
    ...
    /**
     * Publisher identity for JSON-LD NewsArticle/Article structured data.
     * Google requires `publisher.logo` (ImageObject) for valid news rich results.
     * Provide an absolute URL to a logo (recommended >=112px tall, <=600px wide).
     */
    'publisher' => [
        'name' => env('SEO_PUBLISHER_NAME', env('APP_NAME', 'AlphaCMS')),
