...
return [
    ...
    /*
     * Hybrid storage (Phase 2): the LOCAL canonical disk (always written first)
     * and the logical name of the optional REMOTE mirror disk. Remote
     * enable/credentials are operational settings (MediaStorageSettings), not env.
     */
    'canonical_disk' => env('MEDIA_CANONICAL_DISK', 'uploads'),
    'remote_disk' => env('MEDIA_REMOTE_DISK', 'media_remote'),
     ...
     */
    'path_generator' => DomainPathGenerator::class,
