...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             * أوفسايت إلزامي في الإنتاج — اضبط BACKUP_DESTINATION_DISKS=s3
             * (أو "local,s3"). الافتراضي local للتطوير فقط.
             */
    ...
    'notifications' => [
        ...
        'mail' => [
            // وجهة تنبيهات النسخ — إلزامية في الإنتاج عبر BACKUP_NOTIFICATION_EMAIL
